...
> - jika sudah menginstall dan ingin menghapus aplikasi, jangan menggunakan `opkg remove` , tetapi lihat menu di cli dengan perintah `acmt --help` (agar konfigurasi uHTTPd bawaan OpenWrt bisa dipulihkan).
